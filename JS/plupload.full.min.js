  ...
  !(function (e, i) {
    ...
    function n(t, e) {
      for (var i, n = [], r = 0; r < t.length; ++r) {
        if (((i = a[t[r]] || s(t[r])), !i))
          throw "module definition dependecy not found: " + t[r];
        n.push(i);
      }
      e.apply(null, n);
    }
    ...
    r("plupload", [], function () {
          ...
          t.extend(this, {
            ...
            splice: function (i, n) {
              return (
                ...
                (n =
                  "undefinded" !== t.typeOf(n) && i + n < e.length
                    ? n
                    : e.length - i),
                e.splice(i, n)
              );
      ...
      r(
        ...
        ["plupload", "plupload/core/Optionable"],
        function (t, e) {
          return (function (e) {
            function i() {
            ...
            return (
              ...
              t.extend(i.prototype, {
                ...
                pause: function () {
                  var e = this.state;
                  return -1 ===
                    t.inArray(this.state, [i.IDLE, i.RESUMED, i.PROCESSING])
                    ? !1
      ...
      r(
        ...
        function (t, e, i, n) {
          return (function (r) {
            ...
            function o() {
              ...
              return (
                this.forEachItem(function (e) {
                  return e.state === i.IDLE || e.state === i.RESUMED
                    ? ((t = e), !1)
                    : void 0;
                }),
                t ? t : null
            ...
            function a() {
              var t;
              if (this.state !== i.PROCESSING && this.state !== i.PAUSED)
                return !1;
              if (
                this.stats.processing < this.getOption("max_slots") &&
                (t = o.call(this))
              ) {
                if (t.trigger("beforestart"))
                  return t.setOptions(this.getOptions()), t.start();
                t.pause(), a.call(this);
              }
              return !1;
            }
            return (
              ...
              t.extend(s.prototype, {
                ...
                stop: function () {
                  return !s.parent.stop.call(this) ||
                    this.getOption("finish_active")
                    ? !1
                    : (this.isActive() &&
                        this.forEachItem(function (t) {
                          t.stop();
                ...
                isActive: function () {
                  return (
                    this.stats && (this.stats.processing || this.stats.paused)
                  );
                },
                isStopped: function () {
                  ...
                  return e
                    ? (e.reset(),
                      t.forEachItem(function (s) {
                        ...
                        (n += s.processed),
                          (!s.processedTimestamp ||
                            s.processedTimestamp > t.startedTimestamp) &&
                            (r += n),
                ...
                destroy: function () {
                  ...
                  return e.state === i.DESTROYED
                    ...
                    ? (e.bindOnce("Stopped", function () {
                      ...
                      e.stop())
                    : (e.clear(),
                      s.parent.destroy.call(this),
                      (e._queue = e.stats = null),
                      !0);
                },
              }),
              s
                    ...
                    (r = c.multipart ? c.url : i(c.url, c.params)),
                      ...
                      c.multipart
                        ? ((u = new o()),
                          ...
                          a.send(u))
                        : ((e.isEmptyObj(c.headers) ||
                            !a.hasRequestHeader("content-type")) &&
                            a.setRequestHeader(
                              "content-type",
                  ...
                  return this.state === i.PROCESSING
                    ...
                    : (this.startedTimestamp ||
                      ...
                      e._options.chunk_size
                        ? ((p = Math.ceil(s.size / e._options.chunk_size)),
                          e.uploadChunk(!1, !0))
                        : ((t = new n(s)),
      ...
      r(
        ...
        ["plupload", "plupload/core/Queueable"],
        function (e, i) {
          function n(t) {
            i.call(this),
              (this._options = {
        ...
        function (e, i, n, r, s, o) {
              ...
              e.each(n.getOption("runtimes").split(/\s*,\s*/), function (t) {
                ...
                n.getOption("drop_element") &&
                  e.each(n.getOption("drop_element"), function (i) {
                    s.push(function (s) {
                      var a = new t.file.FileDrop(
                        e.extend({}, o, { drop_zone: i })
                      );
                      (a.onready = function () {
                        var t = e.Runtime.getInfo(this.ruid);
                        e.extend(n.features, {
          ...
          function p(t, i, n) {
            switch (t) {
              ...
              case "max_file_size":
                n && !n.filters && (n.filters = {}),
                  (n.filters.max_file_size = i);
                break;
              case "multipart":
              ...
              case "prevent_duplicates":
                n && !n.filters && (n.filters = {}),
                  (n.filters.prevent_duplicates = !!i);
                break;
              case "unique_names":
                i && (n.send_file_name = !0);
                break;
